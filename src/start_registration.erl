...
-record(project, {username, u2f_enroll = [], u2f_device}). %, u2f_enroll, u2f_device , u2f_enroll
...
post_json(Req, State) ->
 ...
 U2F_Device = binary_to_list(U2F_Device_Binary),
  add_user(Username, U2F_Enroll, U2F_Device),% , , U2F_Device),, U2F_Enroll
...
add_user(Username, U2F_Enroll, U2F_Device) ->
  F = fun() ->
